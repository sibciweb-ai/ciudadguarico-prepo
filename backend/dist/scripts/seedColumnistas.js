...
function seedColumnistas() {
    return __awaiter(this, void 0, void 0, function* () {
        const prisma = (0, prisma_1.getPrismaClient)();
        try {
            console.log('🌱 Iniciando seed de columnistas...');
            // Limpiar datos existentes
            yield prisma.opinion.deleteMany();
            yield prisma.columnista.deleteMany();
            // Crear columnistas y guardar sus IDs
            const columnistasCreados = [];
            for (const columnista of columnistasData) {
                const created = yield prisma.columnista.create({
                    data: Object.assign(Object.assign({}, columnista), { redes: columnista.redes })
                });
            ...
            for (const opinion of opinionesData) {
                const created = yield prisma.opinion.create({
                    data: opinion
                });
...
exports.default = seedColumnistas;
